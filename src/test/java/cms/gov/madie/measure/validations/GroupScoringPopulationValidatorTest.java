...
class GroupScoringPopulationValidatorTest {
  ...
  public void testValidatorReturnsFalseForNullPopulation() {
    Group group = Group.builder().scoring(MeasureScoring.COHORT.toString()).population(null).build();
    boolean output = validator.isValid(group, validatorContext);
    assertFalse(output);
  }
  ...
  public void testValidatorReturnsFalseForEmptyPopulation() {
    Group group = Group.builder().scoring(MeasureScoring.COHORT.toString()).population(Map.of()).build();
    boolean output = validator.isValid(group, validatorContext);
    assertFalse(output);
  }
  ...
  public void testValidatorReturnsFalseForInvalidScoring() {
    Map<MeasurePopulation, String> populations = Map.of(MeasurePopulation.INITIAL_POPULATION, "Advanced Illness");
    ...
    return Stream.of(
        ...
        Arguments.of(Group.builder()
            .scoring(MeasureScoring.COHORT.toString())
                .population(Map.of(MeasurePopulation.INITIAL_POPULATION, "",
                    MeasurePopulation.MEASURE_POPULATION, "Something"))
            .build(), false),
        ...
        Arguments.of(Group.builder()
            .scoring(MeasureScoring.PROPORTION.toString())
                .population(Map.of(MeasurePopulation.INITIAL_POPULATION, "pop1",
                    MeasurePopulation.NUMERATOR, "pop2",
                    MeasurePopulation.DENOMINATOR, "pop3"))
            .build(), true),
        ...
        Arguments.of(Group.builder()
            .scoring(MeasureScoring.PROPORTION.toString())
                .population(Map.of(MeasurePopulation.INITIAL_POPULATION, "pop1",
                    MeasurePopulation.NUMERATOR, "pop2",
                    MeasurePopulation.NUMERATOR_EXCLUSION, "pop3",
                    MeasurePopulation.DENOMINATOR, "pop4",
                    MeasurePopulation.DENOMINATOR_EXCLUSION, "pop5",
                    MeasurePopulation.DENOMINATOR_EXCEPTION, "pop6"))
            .build(), true),
        ...
        Arguments.of(Group.builder()
            .scoring(MeasureScoring.PROPORTION.toString())
                .population(Map.of(MeasurePopulation.INITIAL_POPULATION, "pop1",
                    ...
                    MeasurePopulation.DENOMINATOR_EXCLUSION, "pop5",
                    MeasurePopulation.DENOMINATOR_EXCEPTION, "pop6",
                    MeasurePopulation.MEASURE_POPULATION, "pop9"))
            .build(), false),
        ...
        Arguments.of(Group.builder()
            .scoring(MeasureScoring.CONTINUOUS_VARIABLE.toString())
                .population(Map.of(MeasurePopulation.INITIAL_POPULATION, "pop1",
                    MeasurePopulation.MEASURE_POPULATION, "pop2"))
            .build(), true),
        ...
        Arguments.of(Group.builder()
            .scoring(MeasureScoring.CONTINUOUS_VARIABLE.toString())
                .population(Map.of(MeasurePopulation.INITIAL_POPULATION, "pop1",
                    MeasurePopulation.MEASURE_POPULATION, "pop2",
                    MeasurePopulation.MEASURE_POPULATION_EXCLUSION, "pop3"))
            .build(), true),
