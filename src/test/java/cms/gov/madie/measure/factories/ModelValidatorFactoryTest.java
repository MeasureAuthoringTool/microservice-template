...
class ModelValidatorFactoryTest {
  ...
  @Mock QdmModelValidator qdmModelValidator;

  @Mock QiCoreModelValidator qiCoreModelValidator;
  ...
  void setup() {
    modelValidatorFactory =
        new ModelValidatorFactory(
            Map.of(
                ServiceConstants.QDM_VALIDATOR,
                qdmModelValidator,
                ServiceConstants.QICORE_VALIDATOR,
                qiCoreModelValidator));
  }
  ...
  void testFactoryThrowsException() {
    ModelValidatorFactory factory =
        new ModelValidatorFactory(Map.of(ServiceConstants.QDM_VALIDATOR, qdmModelValidator));
    assertThrows(
        UnsupportedTypeException.class, () -> factory.getModelValidator(ModelType.QI_CORE));
  }
}
