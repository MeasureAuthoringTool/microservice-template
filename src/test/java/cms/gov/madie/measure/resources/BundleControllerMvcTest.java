...
public class BundleControllerMvcTest {
  ...
  //            jsonPath("$.message")
  //                .value(
  //                    "Response could not be completed for Measure with ID 1234, since CQL errors
  // exist."));
  //    verify(measureRepository, times(1)).findById(eq("1234"));
  //    verifyNoInteractions(bundleService);
  //  }
  ...
  //            jsonPath("$.message")
  //                .value(
  //                    "Response could not be completed for Measure with ID 1234, since there are
  // no associated measure groups."));
  //    verify(measureRepository, times(1)).findById(eq("1234"));
  //    verifyNoInteractions(bundleService);
  //  }
